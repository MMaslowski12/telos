...
cd XFoil-lib && make distclean && cd .. && make distclean

cd xflrpy && cd XFoil-lib && qmake && make -j4 && cd .. && qmake && make -j

cd xflrpy && cd XFoil-lib && qmake && make -j2 && cd .. && qmake && make -j2 <-- much more stable
'''